...
package com.jahi.pipelinetest.gallery.ui.common
...
import com.jahi.pipelinetest.gallery.ui.common.chat.ChatMessageBenchmarkResult
import com.jahi.pipelinetest.gallery.ui.common.chat.ChatMessageType
import com.jahi.pipelinetest.gallery.ui.common.chat.ChatViewModel
import com.jahi.pipelinetest.gallery.ui.common.chat.Histogram
import com.jahi.pipelinetest.gallery.ui.common.chat.Stat
...
fun Context.createTempPictureUri(
  ...
  return FileProvider.getUriForFile(
    applicationContext,
    "com.jahi.pipelinetest.provider" /* {applicationId}.provider */,
    tempFile
  )
}
...
fun getTaskBgColor(task: Task): Color {
  ...
  val colorIndex: Int = task.index % colors.size
...
fun getTaskIconColor(index: Int): Color {
  ...
  val colorIndex: Int = index % colors.size
  return colors[colorIndex]
}
