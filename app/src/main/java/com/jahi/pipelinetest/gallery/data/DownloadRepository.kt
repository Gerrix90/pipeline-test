...
import com.jahi.pipelinetest.gallery.ui.common.readLaunchInfo
import com.jahi.pipelinetest.gallery.worker.DownloadWorker
...
class DefaultDownloadRepository(
  ...
  private fun sendNotification(title: String, text: String, modelName: String) {
    ...
    val intent = Intent(
      Intent.ACTION_VIEW, Uri.parse("com.jahi.pipelinetest://model/${modelName}")
    ).apply {
